...
const projects: ProjectItem[] = [
  {
    ...
    media: {
      ...
      alt: "Periwinkle Empire brand showcase",
    },
  ...
  },
  {
    ...
    media: {
      ...
      alt: "bCODE digital platform showcase",
    },
    ctaLabel: "View Case Study",
    href: "#",
  },
  {
    ...
    media: {
      ...
      alt: "Aesop skin care brand experience",
    },
            ...
            <article key={project.id} className={styles.card}>
              <div className={styles.cover}>
                ...
                <div className={styles.overlay}>
                  ...
                  <a className={styles.cta} href={project.href}>
                    {project.ctaLabel}
